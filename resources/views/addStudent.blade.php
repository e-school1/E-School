                ...
                <div class="card-body">
                    <form method="POST" action="/addStudent" enctype= multipart/form-data>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="custom-select my-1 mr-sm-2 form-control @error('section') is-invalid @enderror" id="name" name="section" value="{{ old('section') }}" required autocomplete="section" autofocus>
